...
export const isDateISO = v => dateISORegex.test(v);
export const isDateObject = v => (v && v instanceof Date ? true : false);
export const isDateAnyISO = v => isNumber(v) || isDateISO(v);
